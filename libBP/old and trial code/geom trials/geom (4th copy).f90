...
! Forces
                coords(cKeyE)%fracCoords(m,1) = coordsUnit(cKey)%unitForces(n,1)
                coords(cKeyE)%fracCoords(m,2) = coordsUnit(cKey)%unitForces(n,2)
                coords(cKeyE)%fracCoords(m,3) = coordsUnit(cKey)%unitForces(n,3)
              End Do
            End Do
          End Do
        End Do
...
! Store from coords
    ...
    nl(cKey)%coords = coords(cKey)%fracCoords
!----------------------------------------------
