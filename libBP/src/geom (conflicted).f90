...
! Atom details
    Integer(kind=StandardInteger), Dimension(1:20000) :: atomA_ID
    Integer(kind=StandardInteger), Dimension(1:20000) :: atomB_ID
    Integer(kind=StandardInteger), Dimension(1:20000) :: atomA_Type
    Integer(kind=StandardInteger), Dimension(1:20000) :: atomB_Type
    Integer(kind=StandardInteger), Dimension(1:20000) :: inCell
! Position Details
    Real(kind=DoubleReal), Dimension(1:20000) :: rD
    Real(kind=DoubleReal), Dimension(1:20000,1:3) :: vecAB
    Real(kind=DoubleReal), Dimension(1:20000,1:3) :: coordsA
    Real(kind=DoubleReal), Dimension(1:20000,1:3) :: coordsB
! Subcell
    Integer(kind=StandardInteger), Dimension(1:20000,1:3) :: subCell
    Integer(kind=StandardInteger), Dimension(1:20000,1:3) :: cell
! Misc
